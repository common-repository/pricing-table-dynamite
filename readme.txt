...
[Free Upgrade to the Pro version!](http://www.thinklandingpages.com/special/pricing-table-dynamite-free-offer/)

###What's in Pricing Table Pro

* 4 pre-configured color schemes
* 3 pricing table templates
* 7 editable color points to create your own color scheme
* Responsive design for mobile viewing
* Place pricing tables on any page using a shortcode
* Edit content on the pricing table
* Create as many columns as you want on each pricing table
* Unlimited number of rows on each column
* Editable Call-To-Action buttons
* Unlimited number of pricing tables
...
* No forms to fill out, edit right on the pricing table
* Add as many columns and rows as you want
* Each column of your pricing table has a specially formatted header
...
Each row is equipped with a call to action button that allows you to edit the text and save a link to send you customers to when they click the button on your pricing table.  To edit the text, just click on it and start typing right on the pricing table.

To save a link to send your customers to for payment processing, just double click the call to action button on the pricing table edit page and a box will popup for you to save your link.
...
= 1.1.1 =
* Fixed bad constant reference and no $settings variable set
